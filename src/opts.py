...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--task', default='MOD_train',
                                 help='current task')
        ...
        self.parser.add_argument('--model', default='',
                                 help='path to model')
        ...
        self.parser.add_argument('--batch_size', type=int, default=7,
                                 help='batch size')
        ...
        # dataset seetings
        self.parser.add_argument('--dataset', default='dsec',
                                 help='dsec')
        self.parser.add_argument('--split', type=int, default=1,
                                 help='1 split for dsec')
    ...
    def parse(self, args=''):
        ...
        opt.save_dir = opt.model if opt.model != '' else opt.flow_model
